...
export const DeleteTeamModal: Component<Props> = (props) => {
  return (
    <Modal opened={props.toggle}>
      <Card label="Delete Project" class="bg-zinc-800">
        <p class="text-md text-zinc-400">
          Do you really want to delete this team? This action cannot be undone! Everyone
          including you will loose access.
        </p>
