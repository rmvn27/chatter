...
Mit der Quelltext-Generation kann, konnte dann der \code{DatabaseService} geschrieben werden. In diesem
...
Damit können Daten geteilt bei mehreren Backend-Instanzen zwischengespeichert werden. Dies wurde gemacht, um
...
\zb{} der \code{AuthenticationService} oder \emph{AuthorizationService}, welche die Nutzer Authentifikation und
Autorisation steuert. Über den \code{AuthenticationService} dieses können Nutzerkonten erstellt werden
...
bisherige AccessToken abgelaufen ist, kann der RefreshToken verwendet werden,
...
Das das Backend über eine Echtzeit-Komponenten für Chats der einzelnen Teams und zur
...
Konstruktor \zb{} die Klasse initialisierbar ist. Auch wurde es öfters gebraucht, dass Klassen eine
Ansammlung von Instanzen erhalten, welche ein spezifisches Interface erfüllen. Dafür konnten auch
Annotationen gesetzt werden, welche signalisieren, dass eine Klasseninstanz genau dafür verwendet werden kann.

Zum erstellen und instialisieren des gesamten Abhängigkeits-Graphen der Applikation stellt der \code{AppComponent}
