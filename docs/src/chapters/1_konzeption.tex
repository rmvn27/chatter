...
allen Teilnehmern in Echtzeit zugestellt und die Seite muss nicht neugeladen werden, um
neue Nachrichten zu betrachten. Neben den Echtzeit Nachrichten kann auch die Historie des Kanales
...
Ein zusätzlich eingebautes Feature ist die Möglichkeit die Nachrichten mit Hilfe von Markdown formatieren
zu können. So können einzelne Bestandteile dick oder kursiv hervorgehoben werden, Überschriften benutzt
und Quelltext mit Syntax-Highlighting geschrieben werden.
...
Tabelle wird zusätzlich benötigt, um die \anf{refreshTokens} für die spätere
...
Durch \emph{ktor} konnte die REST-Schnitstelle aus auch das Behandeln von Websocket-Verbindungen
